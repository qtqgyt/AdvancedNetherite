...
public final class ModArmorMaterials {
    ...
    public static final ArmorMaterial NETHERITE_IRON = register(
        37,
        ...
        3.5F,
        0.1F,
        ModTags.REPAIRS_NETHERITE_IRON_ARMOR,
        ModEquipmentAssets.NETHERITE_IRON
    );
    public static final ArmorMaterial NETHERITE_GOLD = register(
        37,
        Util.make(new EnumMap<>(ArmorType.class), attribute -> {
        ...
        3.5F,
        0.1F,
        ModTags.REPAIRS_NETHERITE_GOLD_ARMOR,
        ModEquipmentAssets.NETHERITE_GOLD
    );
    public static final ArmorMaterial NETHERITE_EMERALD = register(
        37,
        Util.make(new EnumMap<>(ArmorType.class), attribute -> {
            attribute.put(ArmorType.BOOTS, 5);
        ...
        3.5F,
        0.1F,
        ModTags.REPAIRS_NETHERITE_EMERALD_ARMOR,
        ModEquipmentAssets.NETHERITE_EMERALD
    );
    public static final ArmorMaterial NETHERITE_DIAMOND = register(
        37,
        Util.make(new EnumMap<>(ArmorType.class), attribute -> {
        ...
        4.0F,
        0.1F,
        ModTags.REPAIRS_NETHERITE_DIAMOND_ARMOR,
        ModEquipmentAssets.NETHERITE_DIAMOND
    );
    ...
    private static ArmorMaterial register(
        int durability,
        EnumMap<ArmorType, Integer> typeProtections,
        int enchantability,
        float toughness,
